...
最近有人在 X 上整理了一份 Google 免费 AI 工具清单，声称这些工具大多开源（MIT 协议），能覆盖品牌设计、界面生成、无代码开发、代码助手、学习辅助等多个场景。挨个核实下来，发现里面好几个已经过期或者说法不准确——这篇按原帖内容整理，链接和几处订正都是自己查过的。

{/* truncate */}

> 注意，部分工具仍处于 Labs / Beta 阶段，功能与额度可能随时调整。"完全开源"的说法对个别工具并不完全准确，使用前建议自行确认。原帖编号里没有第 9 条，直接从 8 跳到了 10，这里保留原样，没有替它编一条出来。
